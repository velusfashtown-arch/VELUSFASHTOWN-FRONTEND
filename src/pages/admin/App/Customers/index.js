...
export default function AdminCustomers() {
  ...
  return (
    <div>
{error && <div className="fixed left-4 right-4 top-4 z-50 animate-admin-slide-in rounded-lg border border-[rgba(197,34,31,0.15)] bg-[#fce8e6] px-5 py-3 text-[13px] font-medium text-[#c5221f] shadow-[0_4px_16px_rgba(47,31,25,0.12)] sm:left-auto sm:w-auto">{error}</div>}
