...
export default function StoryBanner() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative z-[2] max-w-[450px] py-[130px] pb-[82px] pl-[13.5vw] max-[620px]:px-[26px] max-[620px]:py-[96px] max-[620px]:pb-[65px] reveal reveal-up ${isVisible ? 'reveal-visible' : ''}`}
      >
